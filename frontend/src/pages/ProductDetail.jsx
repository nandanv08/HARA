                ...
                {images.map((img, i) => (
                  <button
                    ...
                    className={`w-20 h-20 overflow-hidden flex-shrink-0 transition-all ${
                      activeImg === i ? 'ring-2 ring-gold ring-offset-2' : 'opacity-60 hover:opacity-100'
                    }`}
                  >
          ...
          <div className="space-y-4 lg:pt-4">
            ...
            <div className="flex flex-col sm:flex-row gap-4 pt-4">
              <button
                ...
                className={`flex-1 py-5 text-[12px] font-bold tracking-[3px] uppercase transition-all duration-300 shadow-lg shadow-charcoal/10 ${
                  added
                    ? 'bg-gold text-white'
                    : product.inStock
