// ═══════════════════════════════════════════════════════════════
//  Hara Jewellery — Vercel Serverless API
//  Stack: Express · MongoDB (Mongoose) · Razorpay · serverless-http
// ═══════════════════════════════════════════════════════════════
...
app.use(cors({
  origin: [
    "http://localhost:5173",
    "https://hara-jewellery.vercel.app"
  ],
  credentials: true
}));
...
// ══════════════════════════════════════════════════════════════
//  SEED DATA — one-time seeding endpoint (call manually)
// ══════════════════════════════════════════════════════════════
...
app.get('/api/health', (req, res) =>
    res.json({ status: 'ok', service: 'Hara Jewellery API v2 (Vercel)', time: new Date().toISOString() })
);
...
// Seed endpoint — call once manually: GET /api/seed
...
// ══════════════════════════════════════════════════════════════
//  EXPORT FOR VERCEL — serverless-http wraps Express app
//  No app.listen() needed for serverless deployment
// ══════════════════════════════════════════════════════════════
